...
# @edited by jasperan to support new endpoints and SDK calls in OCI v19
# Supports Python 3
##########################################################################
# Info:
...
class AnalyzeVideo:
    ...
    def __init__(
        ...
        self.inline_image_details = oci.ai_vision.models.InlineImageDetails()
        self.analyze_image_details = oci.ai_vision.models.AnalyzeImageDetails()
        self.image_object_detection_feature = oci.ai_vision.models.ImageObjectDetectionFeature()
